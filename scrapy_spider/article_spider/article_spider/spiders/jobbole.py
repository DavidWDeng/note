...
class JobboleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        2，获取下一页的url并交给scrapy下载，下载完了进行parse解析
        :param response:
        :return:
        '''
        ...
        for post_node in post_nodes:
            ...
            yield Request(url=urlparse.urljoin(response.url,post_url),meta={'front_image_url':image_url},callback=self.detail_parse)
